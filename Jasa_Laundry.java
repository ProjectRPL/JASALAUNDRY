        ...
        do{
            ...
            if(kota_Asal.equalsIgnoreCase("JAKARTA PUSAT") || kota_Asal.equalsIgnoreCase("JAKARTA BARAT")
                 || kota_Asal.equalsIgnoreCase("JAKARTA TIMUR") || kota_Asal.equalsIgnoreCase("JAKARTA UTARA")
                  || kota_Asal.equalsIgnoreCase("JAKARTA SELATAN") || kota_Asal.equalsIgnoreCase("JAKARTA")){
                System.out.println("\n---- Selamat anda termasuk dalam jangkauan gratis ongkir ----\n");
                ...
                if((berat) > 5){
                    diskon = ((hagra_jumlah_pakaian + harga_kiloan)* 10)/100;
                    diskon = (hagra_jumlah_pakaian + harga_kiloan) - diskon;
                    dapat_diskon = "---- DISKON 10% ----";
                }else{
                ...
                System.out.println("TERIMAKASIH :)");
                aaa = "no";
            }else if (kota_Asal.equalsIgnoreCase("DEPOK")
                   || kota_Asal.equalsIgnoreCase("TANGGERANG SELATAN")  || kota_Asal.equalsIgnoreCase("TANGGERANG")
                    || kota_Asal.equalsIgnoreCase("BEKASI BARAT")  || kota_Asal.equalsIgnoreCase("BEKASI UTARA")
                     || kota_Asal.equalsIgnoreCase("BEKASI SELATAN") || kota_Asal.equalsIgnoreCase("BEKASI TIMUR")
                      || kota_Asal.equalsIgnoreCase("BEKASI")) {
                System.out.println("\n---- Kota asal anda akan dikenakan biaya ongkir sebesar 9000/kg ----\n");
                ongkir=9000;
                do{
                    System.out.print("ALAMAT TEMPAT TINGGAL : ");
                    alamat = input.nextLine();
                ...
                double totalongkir = (berat * ongkir);
                harga_kiloan = harga_paket * berat;
                if((berat) > 5){
                    diskon = ((hagra_jumlah_pakaian + harga_kiloan)* 10)/100;
                    diskon = (hagra_jumlah_pakaian + harga_kiloan) - diskon;
                ...
                System.out.println(dapat_diskon);
                System.out.println("ONGKIR : Rp."+ digit.format(totalongkir));
                System.out.println("TOTAL HARGA : Rp." + digit.format(diskon+totalongkir));
                System.out.println("");
                System.out.println("\n------------------------------------------------");
                String lanjut_Pembayaran = "";
